...
function show(){
    ...
    /*this sets up rach task as an unordered list*/
    var html='<ul>';
...
/*this creates the functionality of removing  a todo item fromthe array*/
function remove(){
...
/*This tells the browser how to
display the todo array after an item has been removed*/
function show(){
    /*this sets the task that was retrieved as a variable*/
    var todos=get_todos();
