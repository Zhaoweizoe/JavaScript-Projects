...
function myFunction(a,b){//Defining and naming the addition function
...
let y= subtraction_Function(9,5)//function call
    ...
    function subtraction_Function(a,b){//Defining and naming the addition function
        return a-b;//print the result in HTML
...
function more_Math(){//Defining and naming the addition function
...
function negation_Operator(){//Defining and naming the addition function
    var x=12
...
function randonNmuber(){//Defining and naming the addition function
